...
<div class="container-fluid">
    <div class="col-md-2">
        <ul class="nav nav-pills nav-stacked">
            ...
            <li role="presentation">
                <a href="create.php"><i class="glyphicon glyphicon-chevron-right"></i> Add New City</a>
            </li>
            <li role="presentation">
                <a href="index.php"><i class="glyphicon glyphicon-chevron-right"></i> View City List</a>
            </li>
            <li role="presentation">
                <a href="trashed.php"><i class="glyphicon glyphicon-chevron-right"></i> View City Trashed</a>
            </li>
        </ul>
    </div>
    ...
    <div class="col-md-10">
        ...
        <form  role="form" method="post" action="email.php<?php if(isset($_REQUEST['id'])) echo "?id=".$_REQUEST['id']; else echo "?list=1";?>">
            <div class="form-group">
                ...
                <input type="text"  name="subject"  class="form-control" id="subject" value="<?php if($list){echo "List of cityInfo recommendation";} else {echo "A single CityInfo recommendation";} ?>">
...
if($list){
    ...
    printf("<table><tr> <td width='50'><strong>Serial</strong></td><td width='50'><strong>ID</strong></td><td width='250'><strong>Name</strong></td><td width='250'><strong>City Name</strong></td></tr>");
    ...
    foreach($recordSet as $row) {
        ...
        $sl++;
        printf("<tr><td width='50'>%d</td><td width='50'>%d</td><td width='450'>%s</td><td width='550'>%s</td></tr>",$sl,$id,$name,$cityName);
...
{
    printf("I'm recommending You: [<strong>City ID: </strong>%s, <strong>Person Name: </strong>%s, <strong>City Name: </strong>%s]",$singleItem->id,$singleItem->name,$singleItem->city_name);
