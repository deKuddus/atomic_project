...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-12">
            <h1>Trashed List - Organization</h1>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    foreach($allData as $records){
                        ...
                        echo "<tr>
                           ...
                           <td>$serial</td>
                           <td>$records->id</td>
                           <td>$records->orga_name</td>
                           <td>$records->summary</td>
                           <td>
                            <a href='view.php?id=$records->id'><button class='btn btn-primary'>View</button></a>
                            <a href='edit.php?id=$records->id'><button class='btn btn-success'>Edit</button></a>
                            <a href='recover.php?id=$records->id'><button class='btn btn-warning'>Recover</button></a>
                            <a href='delete.php?id=$records->id'><button class='btn btn-danger' onclick='return confirm_delete()'>Delete</button></a>
                           </td>
