            ...
            <div class="col-sm-6 col-sm-offset-3 formInfo">
                ...
                <form action="store.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="orgaName" class="form-control" placeholder="Enter Your Name">
                    </div>

                    <div class="form-group">
                        <label for="summary">Summary</label>
                        <textarea type="text" name="summary" class="form-control" id="text_area" placeholder="Enter Your Tex Here"></textarea>
                    </div>
