...
$profilePicture = new \App\ProfilePicture\ProfilePicture();
...
if(isset($_REQUEST['list'])) {
    ...
    $list= 0;
    $profilePicture->setData($_REQUEST);
...
<div class="container-fluid">
    <div class="col-md-2">
        <ul class="nav nav-pills nav-stacked">
            ...
            <li role="presentation">
                <a href="create.php"><i class="glyphicon glyphicon-chevron-right"></i> Add New Picture</a>
            </li>
            <li role="presentation">
                <a href="index.php"><i class="glyphicon glyphicon-chevron-right"></i> View Picture List</a>
            </li>
            <li role="presentation">
                <a href="trashed.php"><i class="glyphicon glyphicon-chevron-right"></i> View Picture Trashed</a>
            </li>
        </ul>
    </div>
    ...
    <div class="col-md-10">
        ...
        <form  role="form" method="post" action="email.php<?php if(isset($_REQUEST['id'])) echo "?id=".$_REQUEST['id']; else echo "?list=1";?>">
            <div class="form-group">
                ...
                <input type="text"  name="subject"  class="form-control" id="subject" value="<?php if($list){echo "List of picture info recommendation";} else {echo "A single picture info recommendation";} ?>">
...
if($list){
    ...
    foreach($recordSet as $row) {
        ...
        $sl++;
        printf("<tr><td width='50'>%d</td><td width='50'>%d</td><td width='450'>%s</td><td width='550'>%s</td></tr>",$sl,$id,$name,$profilePicture);

        $fp = fopen("contents.html","a+");

        fprintf($fp,"<tr><td width='50'>%d</td><td width='50'>%d</td><td width='450'>%s</td><td width='550'><img src='images/%s' height='100px' width='100px'></td></tr>",$sl,$id,$name,$profilePicture);
...
{
    printf("I'm recommending You: [<strong>Profile ID: </strong>%s, <strong>Person Name: </strong>%s, <strong>Profile Picture: </strong>%s]",$singleItem->id,$singleItem->name,$singleItem->profile_picture);
