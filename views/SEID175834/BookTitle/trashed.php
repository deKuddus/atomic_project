...
<body>
      <div class="container">
          <div class="row">
              <div class="col-sm-12">
                  <div class="col-sm-6" style="width: 500px;height: 150px;padding-top: 50px;padding-left: 0px;">
                      <?php echo "<div id='message'> $msg</div>"?>
                  </div>
              </div>
              <div class="col-sm-12">
              <h1>Trashed List - Book Title</h1>
              ...
              <form action="recover_multiple.php" method="post" id="selectionForm">
                  ...
                  <table class="table table-bordered table-striped">
                      ...
                      foreach($allData as $records){
                       ...
                       <td>$serial</td>
                       <td>$records->id</td>
                       <td>$records->book_title</td>
                       <td>$records->author_name</td>
                       <td>
