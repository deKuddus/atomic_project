...
$gender = new \App\Gender\Gender();

if(isset($_REQUEST['list'])) {
    $list = 1;
    $recordSet = $gender->index();

}
else {
    $list= 0;
    $gender->setData($_REQUEST);
...
<div class="container-fluid">
    <div class="col-md-2">
        <ul class="nav nav-pills nav-stacked">
            ...
            <li role="presentation">
                <a href="create.php"><i class="glyphicon glyphicon-chevron-right"></i> Add New Gender</a>
            </li>
            <li role="presentation">
                <a href="index.php"><i class="glyphicon glyphicon-chevron-right"></i> View Gender List</a>
            </li>
            <li role="presentation">
                <a href="trashed.php"><i class="glyphicon glyphicon-chevron-right"></i> View Gender Trashed</a>
            </li>
        </ul>
    </div>
    ...
    <div class="col-md-10">
        ...
        <form  role="form" method="post" action="email.php<?php if(isset($_REQUEST['id'])) echo "?id=".$_REQUEST['id']; else echo "?list=1";?>">
            <div class="form-group">
                ...
                <input type="text"  name="subject"  class="form-control" id="subject" value="<?php if($list){echo "List of GenderInfo recommendation";} else {echo "A single GenderInfo recommendation";} ?>">
...
{
    printf("I'm recommending You: [<strong>Gender ID: </strong>%s, <strong>Person Name: </strong>%s, <strong>Gender: </strong>%s]",$singleItem->id,$singleItem->name,$singleItem->gender);
